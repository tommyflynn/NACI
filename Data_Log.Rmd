...
list.files(paste0(data_path, "/Data_Reference/Geography"))
...
room_categories <- read_xlsx(paste0(data_path, "Data_Reference/Geography/room categories.xlsx"))
room_categories2 <- read_xlsx(paste0(data_path, "Data_Reference/Geography/room categories2.xlsx"))
room_categories20131204 <- read_xlsx(paste0(data_path, "Data_Reference/Geography/room categories2 20131204.xlsx"))
room_categories20131204_area <- read_xlsx(paste0(data_path, "Data_Reference/Geography/room categories2 20131204 area.xlsx"))
room_location <- read_xlsx(paste0(data_path, "Data_Reference/Geography/Room Locations and Square Footage - with Correction.xlsx"))
```
...
```{r }
pt_list <- read_sas(paste0(data_path, "/USB from George/ZIPped files/sas7bdat/patient_list_good_2_last.sas7bdat"))
kable(head(pt_list))
```
...
# str(pt_acuity)
pt_acuity_s2 <- read_xlsx(paste0(data_path, "Data_Files/ACUITY-patients.xlsx"), sheet = 2, range = "A2:H83")
# str(pt_acuity_s2)
pt_acuity_s3 <- read_xlsx(paste0(data_path, "Data_Files/ACUITY-patients.xlsx"), sheet = 3, range = "A2:G83")
# str(pt_acuity_s3)  
```
...
pt_attributes <- read_sas(paste0(data_path, "path/to/attributes.sas7bdat"))
```
...
### Patient clinical information: `pt_clinical`

```{r ReadData pt_clinical}

```

```{r CleanData pt_clinical}
