...
pt_acuity <- read_xlsx(paste(data_path, "Data_Files/ACUITY-patients.xlsx", sep = "/"))
# str(pt_acuity)
pt_acuity_s2 <- read_xlsx(paste(data_path, "Data_Files/ACUITY-patients.xlsx", sep = "/"), 
                          sheet = 2, 
                          range = "A2:H83")
# str(pt_acuity_s2)
pt_acuity_s3 <- read_xlsx(paste(data_path, "Data_Files/ACUITY-patients.xlsx"), 
                          sheet = 3, 
                          range = "A2:G83")
# str(pt_acuity_s3)  
```
